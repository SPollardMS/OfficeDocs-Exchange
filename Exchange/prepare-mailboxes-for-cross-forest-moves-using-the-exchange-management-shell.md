...
|:-----|:-----|:-----|
| _Identity_ <br/> |Required  <br/> | The _Identity_ parameter uniquely identifies a mailbox in the source forest. Identity can be any of the following: <br/>  Common name (CN) <br/>  Alias <br/> **proxyAddress** property <br/> **objectGuid** property <br/> **DisplayName** property <br/> |
