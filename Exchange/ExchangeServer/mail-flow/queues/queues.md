...
- [Types of queues](queues.md#QueueTypes)
    
- [Queue database files](queues.md#QueueDBFiles)
    
- [Queue properties](queues.md#QueueProperties)
    
  - [NextHopSolutionKey](queues.md#NextHopSolutionKey)
    
  - [IncomingRate, OutgoingRate, and Velocity](queues.md#RatesAndVelocity)
    
  - [Queue status](queues.md#QueueStatus)
    
  - [Other queue properties](queues.md#OtherQueueProperties)
    
- [Message properties](queues.md#MessageProperties)
    
  - [Message status](queues.md#MessageStatus)
    
  - [Other message properties](queues.md#OtherMessageProperties)
    
- [Manage queues and messages in queues](queues.md#ManageQueuesAndMessages)
...
| _QueueDatabaseLoggingPath_ <br/> | `%ExchangeInstallPath%TransportRoles\data\Queue` <br/> |Specifies the default directory for the queue database log files. For instructions on how to change the location of the queue database, see [Change the location of the queue database](change-db-location.md).  <br/> |
...
| _QueueDatabasePath_ <br/> | `%ExchangeInstallPath%TransportRoles\data\Queue` <br/> |Specifies the default directory for the queue database files. For instructions on how to change the location of the queue database, see [Change the location of the queue database](change-db-location.md).  <br/> |
