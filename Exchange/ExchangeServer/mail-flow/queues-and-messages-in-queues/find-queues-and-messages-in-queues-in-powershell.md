...
Also remember that queues exist on Mailbox servers and Edge Transport servers (the Transport service). For more information about queues and messages in queues, see [Queues and messages in queues](queues-and-messages-in-queues.md).
  
 **Contents**
  
- [Queue filtering parameters](find-queues-and-messages-in-queues-in-powershell.md#QueueFilters)
    
  - [Queue identity](find-queues-and-messages-in-queues-in-powershell.md#QueueIdentity)
    
  - [Filter parameter on queue cmdlets](find-queues-and-messages-in-queues-in-powershell.md#QueueFilterParam)
    
  - [Include and Exclude parameters on Get-Queue](find-queues-and-messages-in-queues-in-powershell.md#IncludeAndExclude)
    
- [Get-QueueDigest](find-queues-and-messages-in-queues-in-powershell.md#GetQueueDigest)
    
- [Message filtering parameters](find-queues-and-messages-in-queues-in-powershell.md#MessagesFilters)
    
  - [Message identity](find-queues-and-messages-in-queues-in-powershell.md#MessageIdentity)
    
  - [Filter parameter on message cmdlets](find-queues-and-messages-in-queues-in-powershell.md#MessageFilterParam)
    
  - [Queue parameter](find-queues-and-messages-in-queues-in-powershell.md#QueueParam)
    
- [Comparison operators to use when filtering queues or messages](find-queues-and-messages-in-queues-in-powershell.md#ComparisonOperators)
    
- [Advanced paging parameters](find-queues-and-messages-in-queues-in-powershell.md#PagingParameters)
...
[Return to top](find-queues-and-messages-in-queues-in-powershell.md#RTT)
...
| `<Server>\Shadow\<QueueInteger>` or  `Shadow\<QueueInteger>` <br/> |A shadow queue on the specified or local server. For more information about shadow queues and shadow redundancy, see [Shadow redundancy in Exchange 2016](../../mail-flow/transport-ha/shadow-redundancy.md).  <br/> |
...
For a list of comparison operators you can use with the  _Filter_ parameter, see the [Comparison operators to use when filtering queues or messages](find-queues-and-messages-in-queues-in-powershell.md#ComparisonOperators) section in this topic. 
...
| _DetailsLevel_ <br/> | Valid values are:  <br/>  `Normal` This is the default value. The following properties are returned in the results:  <br/> **QueueIdentity** <br/> **ServerIdentity** <br/> **MessageCount** <br/>  `Verbose` The following additional properties are returned in the results:  <br/> **DeferredMessageCount** <br/> **LockedMessageCount\*** <br/> **IncomingRate** <br/> **OutgoingRate** <br/> **Velocity** <br/> **NextHopDomain** <br/> **NextHopCategory** <br/> **NextHopConnector** <br/> **DeliveryType** <br/> **Status** <br/> **RiskLevel\*** <br/> **OutboundIPPool\*** <br/> **LastError** <br/> **TlsDomain** <br/>  * These properties are reserved for internal Microsoft use, and aren't used in on-premises Exchange organizations. For more information about all properties in this list, see [Queue properties](queue-properties.md).  <br/>  `None` The queue name is omitted from the **Details** column in the results.  <br/> |
| _Filter_ <br/> |Filter queues based on the queue properties as described in the [Filter parameter on queue cmdlets](find-queues-and-messages-in-queues-in-powershell.md#QueueFilterParam) section. You can use any of the filterable queue properties as described in the [Queue properties](queue-properties.md) topic.  <br/> |
