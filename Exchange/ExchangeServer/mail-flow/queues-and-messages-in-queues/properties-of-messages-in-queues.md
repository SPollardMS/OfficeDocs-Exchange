...
|n/a  <br/> | `Identity` <br/> |n/a  <br/> |The identity of the message in the form of  _\<Server\>_\ _\<Queue\>_\ _\<MessageInteger\>_. For more information see [Message identity](find-queues-and-messages-in-queues-in-powershell.md#MessageIdentity).  <br/> |
...
|**Queue ID** <br/> | `Queue` <br/> |**Equals** (  `-eq`)  <br/> **Does Not Equal** (  `-ne`)  <br/> **Contains** (  `-contains`)  <br/> |The queue that holds the message. The queue identity uses the syntax  _\<Server\>\\<Queue\>_. For more information, see [Queue identity](find-queues-and-messages-in-queues-in-powershell.md#QueueIdentity).  <br/> |
