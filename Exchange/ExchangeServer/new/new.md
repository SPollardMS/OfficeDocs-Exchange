...
Choose the section below that matches the version of Exchange that you're upgrading from. If you want to know about features that have been removed or replaced in Exchange 2016, see [What's discontinued in Exchange 2016](discontinued.md).
  
For more information about deploying Exchange 2016, see [Planning and deployment](../plan-deploy/plan-deploy.md)
...
[Exchange 2016 architecture](new.md#Architecture2013)
  
[Clients](new.md#Clientsfrom2013)
  
[Outlook on the web (formerly Outlook Web App)](new.md#OutlookAppfrom2013)
  
[MAPI over HTTP](new.md#MAPIHTTP2013)
  
[Document collaboration ](new.md#DocCollab2013)
  
[Office 365 hybrid](new.md#O3652013)
  
[Messaging policy and compliance](new.md#Compliance2013)
  
[Data loss prevention](new.md#DLP2013)
  
[In-place Archiving, retention, and eDiscovery](new.md#Archiving2013)
...
For more information, see [MAPI over HTTP in Exchange 2016](../clients/mapi-http/mapi-http.md).
...
To learn more about DLP, see [Data loss prevention in Exchange 2016](../messaging-policy-and-compliance/dlp/dlp.md).
...
[Exchange admin center](new.md#EAC2010)
  
[Exchange 2016 architecture](new.md#Architecture2010)
  
[Setup](new.md#Setup2010)
  
[Office 365 hybrid](new.md#O3652010)
  
[Messaging policy and compliance](new.md#Compliance2010)
  
[Antimalware protection](new.md#Malware2010)
  
[Mail flow and the transport pipeline](new.md#Mail2010)
  
[Sharing and collaboration](new.md#Sharing2010)
  
[Integration with SharePoint and Skype for Business](new.md#Integrate2010)
  
[Clients](new.md#Clientsfrom2010)
  
[Batch mailbox moves](new.md#Batch2010)
  
[High availability and site resilience](new.md#HA2010)
  
[Exchange workload management](new.md#WLM2010)
...
- **Secure the ECP virtual directory** You can control access to the EAC from inside and outside your corporate network without affecting user access to their Outlook on the web options. For more information, see [Turn off access to the Exchange admin center](../architecture/cas/eac-access.md).
...
For more information, see [Planning and deployment](../plan-deploy/plan-deploy.md).
...
For more information about anti-malware protection, see [Antimalware protection in Exchange 2016](../spam-and-malware/antimalware/antimalware.md).
...
For more information, see [Plan Exchange 2016 integration with SharePoint and Skype for Business](../plan-deploy/integration-with-sharepoint-and-skype/integration-with-sharepoint-and-skype.md).
...
- **Managed Store** See the [Managed Store](new.md#ManagedStore) section. 
...
For more information about these features, see [High Availability and Site Resilience](http://technet.microsoft.com/library/6628285e-d07c-443d-866b-be784ad1ed1e.aspx) and [Changes to high availability and site resilience over previous versions](../ha/changes.md).
...
For more information about these features, see [User workload management in Exchange 2016](../server-health-and-performance/wlm.md).
