...
2. In UNRESOLVED_TOKEN_VAL(exsdkEMS), run the following:
...
3. In UNRESOLVED_TOKEN_VAL(exsdkEMS), set the Persisted Capabilities (msExchCapabilityIdentifiers) by running the following command:
