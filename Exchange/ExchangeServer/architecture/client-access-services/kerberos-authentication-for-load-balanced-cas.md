...
- [Single Active Directory site](kerberos-authentication-for-load-balanced-cas.md#singleADsite)
    
- [Multiple Active Directory sites](kerberos-authentication-for-load-balanced-cas.md#multipleADsite)
