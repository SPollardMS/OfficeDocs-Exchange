...
description: "Learn about SSL, TLS, encryption, and digital certificates in Exchange 2016."
---
...
The properties of these self-signed certificates are described in the [Properties of the default self-signed certificates](digital-certificates-and-encryption.md#DefaultCertificateProperties) section. 
...
[Return to top](digital-certificates-and-encryption.md#RTT)
...
|Secure/Multipurpose Internet Mail Extensions (S/MIME)  <br/> |For more information, see [S/MIME for message signing and encryption](../../messaging-policy-and-compliance/s-mime-for-message-signing-and-encryption.md).  <br/> |
