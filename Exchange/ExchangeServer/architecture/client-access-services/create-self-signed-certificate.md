...
3. The **New Exchange certificate** wizard opens. On the **This wizard will create a new certificate or a certificate request file** page, select **Create a self-signed certificate**, and then click **Next**.
    ...
    **Note:** To create a new certificate request for a certificate authority, see [Create an Exchange 2016 certificate request for a certification authority](create-certificate-request-for-certification-authority.md).
