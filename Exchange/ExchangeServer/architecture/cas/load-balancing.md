...
Read more about HTTP and Exchange 2016 in the topic [MAPI over HTTP in Exchange 2016](../../clients/mapi-http/mapi-http.md).
...
Read more about managed availability in [Managed availability](../../ha/managed-availability/managed-availability.md).
