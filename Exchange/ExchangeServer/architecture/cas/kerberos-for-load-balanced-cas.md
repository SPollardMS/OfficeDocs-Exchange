...
- [Single Active Directory site](kerberos-for-load-balanced-cas.md#singleADsite)
    
- [Multiple Active Directory sites](kerberos-for-load-balanced-cas.md#multipleADsite)
