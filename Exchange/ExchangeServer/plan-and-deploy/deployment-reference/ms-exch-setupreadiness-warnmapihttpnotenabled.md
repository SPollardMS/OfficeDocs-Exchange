...
For more information about MAPI over HTTP and how to enable it, see [MAPI over HTTP in Exchange 2016](../../clients-and-mobile/mapi-over-http/mapi-over-http.md). 
