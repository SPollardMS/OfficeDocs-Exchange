...
1. Use the information in [Updates for Exchange 2016](../../new/updates.md) to download the latest version of Exchange 2016. You can download the ISO image file locally on the computer where you want to install the management tools, or to a central network location. 
...
For more information, see [Install Exchange 2016 using unattended mode](../../plan-deploy/deploy-new-installations/unattended-installs.md).
