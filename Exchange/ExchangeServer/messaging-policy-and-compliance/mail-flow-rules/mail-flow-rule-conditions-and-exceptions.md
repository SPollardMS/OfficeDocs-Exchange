...
The tables in the following sections describe the conditions and exceptions that are available in mail flow rules on Mailbox servers. The properties types are described in the [Property types](mail-flow-rule-conditions-and-exceptions.md#PropertyTypes) section. 
...
|**The sender has overridden the Policy Tip** <br/> **The sender** \> **has overridden the Policy Tip** <br/> | _HasSenderOverride_ <br/>  _ExceptIfHasSenderOverride_ <br/> |n/a  <br/> |Messages where the sender has chosen to override a data loss prevention (DLP) policy. For more information about DLP policies, see [Data loss prevention in Exchange 2016](../../messaging-policy-and-compliance/data-loss-prevention/data-loss-prevention.md).  <br/> |Exchange 2013 or later  <br/> |
...
The conditions in this section that look for values in the **To** and **Cc** fields behave like the conditions in the [Any recipients](mail-flow-rule-conditions-and-exceptions.md#AnyRecipients) section (  *all*  recipients of the message are affected by the rule, not just the detected recipients). 
