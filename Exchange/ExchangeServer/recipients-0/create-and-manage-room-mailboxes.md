...
If you want to learn about the types of recipients that are available in Exchange 2016, check out [Recipients](recipients-0.md). For info about another type of resource mailbox, check out [Manage equipment mailboxes](manage-equipment-mailboxes.md).
