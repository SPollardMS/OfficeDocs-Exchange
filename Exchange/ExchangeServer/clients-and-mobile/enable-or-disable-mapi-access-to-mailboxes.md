...
description: "Learn how administrators can enable or disable MAPI access to specific mailboxes in Exchange 2016."
---
...
- [Enable or disable Outlook on the web access to mailboxes in Exchange 2016](outlook-on-the-web/enable-or-disable-outlook-on-the-web-access-to-mailboxes.md)
    
- [Enable or disable Exchange ActiveSync access to mailboxes in Exchange 2016](activesync/enable-or-disable-exchange-activesync-access-to-mailboxes.md)
    
- [Enable or disable POP3 or IMAP4 access to mailboxes in Exchange 2016](pop3-and-imap4/enable-or-disable-pop3-or-imap4-access-to-mailboxes.md)
...
- You need to be assigned permissions before you can perform this procedure or procedures. To see what permissions you need, see the "Client Access user settings" entry in the [Clients and mobile devices permissions](../permissions/feature-permissions/clients-and-mobile-devices.md) topic. 
