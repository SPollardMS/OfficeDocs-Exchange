...
For more information about ActiveSync, see [Exchange ActiveSync](activesync.md).
...
- [Enable or disable Outlook on the web access to mailboxes in Exchange 2016](../../clients-and-mobile/outlook-on-the-web/enable-or-disable-outlook-on-the-web-access-to-mailboxes.md)
    
- [Enable or disable POP3 or IMAP4 access to mailboxes in Exchange 2016](../../clients-and-mobile/pop3-and-imap4/enable-or-disable-pop3-or-imap4-access-to-mailboxes.md)
    
- [Enable or disable MAPI access to mailboxes in Exchange 2016](../../clients-and-mobile/enable-or-disable-mapi-access-to-mailboxes.md)
...
- You need to be assigned permissions before you can perform this procedure or procedures. To see what permissions you need, see the "Exchange ActiveSync settings" entry in the [Clients and mobile devices permissions](../../permissions/feature-permissions/clients-and-mobile-devices.md) topic. 
