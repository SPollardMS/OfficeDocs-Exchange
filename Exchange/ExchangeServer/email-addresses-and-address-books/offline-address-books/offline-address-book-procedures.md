...
- [Use the Exchange Management Shell to view offline address books](offline-address-book-procedures.md#ViewOAB)
    
- [Use the Exchange Management Shell to create offline address books](offline-address-book-procedures.md#CreateOAB)
    
- Use the Exchange Management Shell to modify offline address books:
    
  - [Use the Exchange Management Shell to configure the default offline address book](offline-address-book-procedures.md#OABConfigDefault)
    
  - [Use the Exchange Management Shell to add and remove address lists from offline address books](offline-address-book-procedures.md#OABAddRemoveAddressLists)
    
  - [Use the Exchange Management Shell to change the organization mailbox that's responsible for generating an offline address book](offline-address-book-procedures.md#OABChangeOrgMailbox)
    
  - [Use the Exchange Management Shell to configure any virtual directory in the organization to accept download requests for the OAB](offline-address-book-procedures.md#OABAllVdirs)
    
  - [Use the Exchange Management Shell to enable shadow distribution for offline address books](offline-address-book-procedures.md#OABEnableShadow)
    
- [Use the Exchange Management Shell to update offline address books](offline-address-book-procedures.md#UpdateOAB)
    
- [Use the Exchange Management Shell to remove offline address books](offline-address-book-procedures.md#RemoveOAB)
    
- [Use the Exchange Management Shell to find organization mailboxes](offline-address-book-procedures.md#FindOrgMailboxes)
    
- [Use the Exchange Management Shell to create organization mailboxes](offline-address-book-procedures.md#CreateOrgMailboxes)
    
- [Assign offline address books to mailbox databases](offline-address-book-procedures.md#OABforDB)
    
- [Use the Exchange Management Shell to assign offline address books to mailboxes](offline-address-book-procedures.md#OABforMailboxes)
    
To change the OAB generation schedule, see [Change the offline address book generation schedule in Exchange 2016](../../plan-and-deploy/post-installation-tasks/change-offline-address-book-generation-schedule.md).
 ...
 **Note**: To configure an arbitration mailbox that you can use as an organization mailbox, see [Use the Exchange Management Shell to create organization mailboxes](offline-address-book-procedures.md#CreateOrgMailboxes).
