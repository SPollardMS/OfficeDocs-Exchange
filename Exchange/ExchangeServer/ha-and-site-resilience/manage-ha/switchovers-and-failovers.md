...
For detailed steps about how to perform a database switchover, see [Activate a mailbox database copy](activate-db-copy.md).
...
For detailed steps about how to perform a server switchover, see [Perform a server switchover](server-switchover.md).
...
For more information about Active Manager's best copy selection process, see [Active Manager](../../ha-and-site-resilience/dags/active-manager.md).
