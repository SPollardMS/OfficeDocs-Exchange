---
title: Message properties and search operators for In-Place eDiscovery in Exchange 2016
ms.prod: EXCHANGE
...
<a name="toc"> </a>
 ...
 [Searchable properties in Exchange](message-properties-and-search-operators-for-in-place-ediscovery-in-exchange-2016.md#properties)
  
    
    
 [Supported search operators](message-properties-and-search-operators-for-in-place-ediscovery-in-exchange-2016.md#boolean)
  
    
    
 [Unsupported characters in search queries](message-properties-and-search-operators-for-in-place-ediscovery-in-exchange-2016.md#unsupportedcharacters)
  
    
    
 [Search tips and tricks](message-properties-and-search-operators-for-in-place-ediscovery-in-exchange-2016.md#tips)
...
|Bcc  <br/> |The BCC field of an email message.1 <br/> |bcc:pilarp@contoso.com  <br/> bcc:pilarp  <br/> bcc:"Pilar Pinilla"  <br/> |All examples return messages with Pilar Pinilla included in the Bcc field.  <br/> |
...
|Cc  <br/> |The CC field of an email message.1 <br/> |cc:pilarp@contoso.com  <br/> cc:"Pilar Pinilla"  <br/> |In both examples, messages with Pilar Pinilla specified in the CC field.  <br/> |
|From  <br/> |The sender of an email message.1 <br/> |from:pilarp@contoso.com  <br/> from:contoso.com  <br/> |Messages sent by the specified user or sent from a specified domain.  <br/> |
...
|Recipients  <br/> |All recipient fields in an email message; these fields are To, CC, and BCC.1 <br/> |recipients:garthf@contoso.com  <br/> recipients:contoso.com  <br/> |Messages sent to garthf@contoso.com.  <br/> The second example returns messages sent to any recipient in the contoso.com domain.  <br/> |
...
|To  <br/> |The To field of an email message.1 <br/> |to:annb@contoso.com  <br/> to:annb  <br/> to:"Ann Beebe"  <br/> |All examples return messages where Ann Beebe is specified in the To: line.  <br/> |
...
|<  <br/> |property<value  <br/> |Denotes that the property being searched is less than the specified value. 1 <br/> |
|>  <br/> |property>value  <br/> |Denotes that the property being searched is greater than the specified value.1 <br/> |
|<=  <br/> |property<=value  <br/> |Denotes that the property being searched is less than or equal to a specific value.1 <br/> |
|>=  <br/> |property>=value  <br/> |Denotes that the property being searched is greater than or equal to a specific value.1 <br/> |
|..  <br/> |property:value1..value2  <br/> |Denotes that the property being searched is greater than or equal to value1 and less than or equal to value2.1 <br/> |
