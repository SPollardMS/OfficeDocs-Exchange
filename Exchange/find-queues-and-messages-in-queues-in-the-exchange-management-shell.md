...
| _Filter_ <br/> |Filter queues based on the queue properties as described in the  [Filter parameter on queue cmdlets](find-queues-and-messages-in-queues-in-the-exchange-management-shell.md#QueueFilterParam) section. You can use any of the filterable queue properties as described in the [Queue properties](queue-properties.md) topic. <br/> |
