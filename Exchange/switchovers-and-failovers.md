...
Looking for management tasks related to high availability and site resilience? See  [Managing high availability and site resilience](managing-high-availability-and-site-resilience.md).
## Switchovers
...
For detailed steps about how to perform a database switchover, see  [Activate a mailbox database copy](activate-a-mailbox-database-copy.md).
...
For detailed steps about how to perform a server switchover, see  [Perform a server switchover](perform-a-server-switchover.md).
...
For more information about Active Manager's best copy selection process, see  [Active Manager](active-manager.md).
