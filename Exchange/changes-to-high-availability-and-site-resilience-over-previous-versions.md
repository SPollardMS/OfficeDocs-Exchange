...
For more information about managed availability, see  [Managed Availability](managed-availability.md).
...
![Multiple databases per volume](images/ITPro_Mailbox_MultipleDBPerVolume.gif)
...
For more information, see  [AutoReseed](autoreseed.md). For detailed steps to configure AutoReseed, see  [Configure AutoReseed for a database availability group](configure-autoreseed-for-a-database-availability-group.md).
