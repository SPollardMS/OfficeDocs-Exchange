---
title: Running Windows antivirus software on Exchange 2016 servers
ms.prod: EXCHANGE
...
- Memory-resident scanning orreal-time protection monitors all files and processes that are loaded and running in a computer's active memory.
 ...
 **Contents**
 ...
 [Folder exclusions](running-windows-antivirus-software-on-exchange-2016-servers.md#Folder)
  
    
    
 [Process exclusions](running-windows-antivirus-software-on-exchange-2016-servers.md#Process)
  
    
    
 [File name extension exclusions](running-windows-antivirus-software-on-exchange-2016-servers.md#FileName)
...
|%SystemRoot%\\Temp\\OICE_ _<GUID>_\\  <br/> |Exchange Search  <br/> |Temporary files used by the Exchange Search service and Microsoft Filter Pack to perform file conversion in a sandboxed environment.  <br/> |Mailbox servers  <br/> |
 ...
 [Recommended exclusions for Windows antivirus programs on Exchange 2016 servers](running-windows-antivirus-software-on-exchange-2016-servers.md#RTT)
