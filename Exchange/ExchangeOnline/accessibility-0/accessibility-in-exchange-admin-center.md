---
title: "Accessibility in the Exchange admin center"
ms.author: dmaguire
author: msdmaguire
ms.date: 12/9/2016
ms.audience: ITPro
...
description: "The Exchange admin center (EAC) in Exchange Online includes accessibility features that make it easy for users with limited dexterity, low vision, or other disabilities to work with files. This means you can use keyboard shortcuts, a screen reader, or a speech recognition tool to work with the EAC."
---
...
- [Explore the EAC user interface](accessibility-in-exchange-admin-center.md#BKMK_userinterface)
    
- [Use a screen reader and keyboard shortcuts](accessibility-in-exchange-admin-center.md#BKMK_screenreader)
    
- [Technical support for customers with disabilities](accessibility-in-exchange-admin-center.md#BKMK_DAD)
